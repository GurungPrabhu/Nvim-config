  ...
  dependencies = {
    { "nvim-lua/plenary.nvim" },
    {
      ...
      opts = function(_, opts)
        ...
        maps.n[prefix .. "e"] = { ":CopilotChatExplain<CR>", desc = "Explain Code" }
        maps.n[prefix .. "r"] = { ":CopilotChatReview<CR>", desc = "Review Code" }
        maps.n[prefix .. "f"] = { ":CopilotChatFix<CR>", desc = "Fix Code Issues" }
        maps.n[prefix .. "T"] = { ":CopilotChatTests<CR>", desc = "Generate Tests" }
